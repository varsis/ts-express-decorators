 ...
 */
/** */
var SessionFilter_1 = require("../components/SessionFilter");
/**
 ...
 * @returns {Function}
 */
function Session(expression, useType) {
    return function (target, propertyKey, parameterIndex) {
        if (typeof parameterIndex === "number") {
            ParamRegistry_1.ParamRegistry.useFilter(SessionFilter_1.SessionFilter, {
                target: target,
