 ...
 * @returns {Function}
 */
export declare function CookiesParams(expression?: string | any, useType?: any): Function;
/**
 * Cookies o CookiesParams return the value from [request.cookies](http://expressjs.com/en/4x/api.html#req.cookies) object.
 *
 * #### Example
 ...
 * @returns {Function}
 */
export declare function Cookies(expression?: string | any, useType?: any): Function;
