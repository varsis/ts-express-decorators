        ...
        if (conf) {
            ...
            if (conf.validate) {
                return new Promise(function (resolve, reject) {
                    ts_log_debug_1.$log.debug(spec_1);
                    return _this.validateMiddleware()(_this.getDefaultSpec(), _this.expressApplication, function (err, middleware) {
                        if (err) {
                        ...
                        _this.expressApplication.use(middleware.metadata(), middleware.files(), middleware.parseRequest(), middleware.validateRequest(), function (req, res, next) { return console.log('EXPRESS MIDDLEWARE'); });
